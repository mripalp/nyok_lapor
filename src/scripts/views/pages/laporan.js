...
const Laporan = {
  async render() {
      ...
      <div class="flex justify-center">
        <div class=" lg:w-[1162px] relative bg-white rounded-[20px] shadow border border-black">
          ...
          <form class="p-4 lg:p-8 flex flex-col items-center">
            ...
            <input type="file" class="text-black text-2xl font-bold font-['Poppins'] h-[74px]  border-2 border-black rounded-sm px-2 py-1 w-full lg:max-w-[800px] mb-2">
    ...
    <div class="ml-[45px] mt-[40px] text-black text-5xl font-bold font-['Poppins'] justify-center ">IMPORT PENGGUNA</div>
